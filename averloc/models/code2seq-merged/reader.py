...
if __name__ == '__main__':
    ...
    repl_tokens = ["@R_%d@"%i for i in range(1, args.num_replace_tokens+1)]
    ...
    class Config:
        def __init__(self):
            ...
            self.TRAIN_PATH = self.TEST_PATH = '/home/hx/data/averloc/datasets/adversarial/depth-1-attack-on-normal/ast-paths/c2s/java-small/gradient-targeting/attack-on-trainset/adv/data'
            self.BATCH_SIZE = 2
    ...
    '''
    reader = Reader(subtoken_to_index, target_to_index, node_to_index, config)
